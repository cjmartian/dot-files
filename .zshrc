...
export ZSH="/Users/cmartin/.oh-my-zsh"
...
plugins=(git autopep8 copyfile docker extract python)
...
alias vim=/usr/local/Cellar/macvim/8.1-160/bin/vim
alias dirm="docker image rm"
alias dils="docker image ls -a"

# some exports for vim plugins
# lightline
export TERM=xterm-256color

# utils
# eval $(thefuck --alias oof --enable-experimental-instant-mode)

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/Users/cmartin/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
